...
public class UnRegularPhotoSortrView extends View implements
		MultiTouchObjectCanvas<UnRegularPhotoSortrView.Img> {
	...
	public UnRegularPhotoSortrView(Context context) {
		this(context, null);
	}

	public UnRegularPhotoSortrView(Context context, AttributeSet attrs) {
	...
	class Img {
		...
		private void initPath() {
			...
			case 0:
				LTY = 0;
				RTX = (display.widthPixels - border) / 2;
				path.moveTo(0, LTY);
				path.lineTo(0, LTY + itemHgt * 3 / 2);
			...
			case 1:
				LTY = 0;
				LTX = (display.widthPixels + border) / 2;
				RTX = display.widthPixels;
				path.moveTo(LTX, LTY);
				path.lineTo(LTX, LTY + itemHgt);
				path.lineTo(RTX, LTY + itemHgt * 3 / 2);
				path.lineTo(RTX, LTY);
				path.close();
				break;
			case 2:
				LTY = itemHgt * 3 / 2 + border;
				RTX = display.widthPixels;
				float CX = (display.widthPixels) / 2;
				float CY = (float) (itemHgt + Math.sqrt(3.0) * border / 2);
				path.moveTo(0, LTY);
				path.lineTo(0, (itemHgt + border) * order + itemHgt);
				path.lineTo(RTX, (itemHgt + border) * order + itemHgt);
				path.lineTo(RTX, LTY);
				path.lineTo(CX, CY);
				path.close();
				break;
